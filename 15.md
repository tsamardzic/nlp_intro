...
|   | Apertus 70B | Olmo 3 32B Think | EuroLLM 22B Instruct | 
| ---- | --------| ------- | ------- |
| format and chat template | [Apertus Chat Format Specification](https://github.com/swiss-ai/apertus-format/blob/main/docs/format.md) | OpenAPI specification | axolotl  |
