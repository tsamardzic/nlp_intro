...
|     | Apertus 70B | Olmo 3 32B Think | EuroLLM 22B Instruct | 
| -----| --------| ------- | ------- |
 costs      |  at scales from 2048 to 4096 GPUs over several months,  6.74×1024 FLOPs,  6 million GPU hours, the model can be realistically trained in approximately 90 days on 4096 GPU | 56 days on a cluster with 1024 H100 GPUs, approx. 1.4 million GPU hours  | 1.7 GPU hours credit  | 
